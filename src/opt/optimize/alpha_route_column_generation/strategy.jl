export AlphaRouteColumnGenerationStrategy

struct AlphaRouteColumnGenerationStrategy <: AbstractIterativeSolveStrategy
    config::AlphaRouteColumnGenerationConfig
end

function initialize_iteration_state(
    strategy::AlphaRouteColumnGenerationStrategy,
    model::AlphaRouteModel,
    data::StationSelectionData
)::AlphaRouteColumnGenerationState
    ...
    return AlphaRouteColumnGenerationState(route_pool, nothing, nothing)
end
...
iteration_state_size(strategy::AlphaRouteColumnGenerationStrategy, state::AlphaRouteColumnGenerationState)::Int =
...
function finalize_iterative_result!(
    ...
    history::Vector{IterativeSolveIterationSummary},
    final_state::AlphaRouteColumnGenerationState,
