...
(`AggregateODRouteProblem` + `NearestOpenAggregateODAssignmentPolicy`, `BendersY`/`BendersYZ`
...
function _unit_weighted_routing_model(
    model::AggregateODRouteProblem; max_stops::Union{Int, Nothing}=model.max_stops,
