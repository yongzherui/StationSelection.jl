"""
Public API for testing AggregateODRouteProblem's Benders decomposition
...
function _benders_subproblem_api_setup(data::StationSelectionData, model::AggregateODRouteProblem)
