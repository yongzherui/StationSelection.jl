# =============================================================================
# ZCorridorODModel (z-based corridor activation)
# =============================================================================

function build_model(
        model::ZCorridorODModel,
    ...
    variable_counts["cluster_activation"] = add_cluster_activation_variables!(m, data, mapping)
    ...
    constraint_counts["cluster_activation"] = add_cluster_activation_constraints!(m, data, mapping)
    constraint_counts["corridor_activation"] = add_corridor_activation_constraints!(m, data, mapping)
