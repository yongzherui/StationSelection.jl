...
Two covering constraints enforce demand coverage by routes and vehicle capacity
per route segment. d_{jkts} is inlined as an expression (not a decision variable).
"""
