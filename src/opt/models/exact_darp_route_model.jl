"""
ExactDARPRouteModel — route-based station selection with α as a fixed parameter.
...
Everything else uses the standard station selection, activation, assignment, and
route deployment objective structure.
"""
...
"""
    ExactDARPRouteModel <: AbstractODModel
...
"""
struct ExactDARPRouteModel <: AbstractODModel
    k                           :: Int
    l                           :: Int
