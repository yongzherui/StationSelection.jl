"""
Core label-DP primitives for `darp_modified/`'s branching passenger free-assignment
pricing: label creation, extension, and dominance. `darp_modified.jl` orchestrates
...
`_joint_routing_assignment_darp_modified_commit_subsets`, `data.jl`) without changing
that shared contract, `_joint_routing_assignment_darp_modified_candidate_next_nodes`
