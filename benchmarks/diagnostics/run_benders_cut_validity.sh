...
# monolithic exactness references. See benders_cut_validity_seeds.jl's docstring.
#SBATCH --job-name=benders_cv
...
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-cv-%j.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-cv-%j.err
set -euo pipefail
