...
# monolithic exactness references. See benders_cg_oracle.jl's docstring.
#SBATCH --job-name=benders_or
...
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-or-%j.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-or-%j.err
set -euo pipefail
