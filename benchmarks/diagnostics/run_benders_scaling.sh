...
# monolithic exactness references. See benders_scaling_s3.jl's docstring.
#SBATCH --job-name=benders_sc
...
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-sc-%j.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-sc-%j.err
set -euo pipefail
...
stdbuf -oL -eL julia --startup-file=no --color=no --project="$PROJECT_ROOT" \
    benchmarks/diagnostics/benders_scaling_s3.jl
