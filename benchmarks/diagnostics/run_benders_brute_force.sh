...
# monolithic exactness references. See benders_brute_force_certificate.jl's docstring.
#SBATCH --job-name=benders_bf
...
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-bf-%j.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-bf-%j.err
set -euo pipefail
...
stdbuf -oL -eL julia --startup-file=no --color=no --project="$PROJECT_ROOT" \
    benchmarks/diagnostics/benders_brute_force_certificate.jl
