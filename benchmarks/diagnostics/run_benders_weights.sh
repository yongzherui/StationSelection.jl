...
# monolithic exactness references. See benders_weight_sensitivity.jl's docstring.
#SBATCH --job-name=benders_ws
...
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-ws-%j.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-ws-%j.err
set -euo pipefail
...
stdbuf -oL -eL julia --startup-file=no --color=no --project="$PROJECT_ROOT" \
    benchmarks/diagnostics/benders_weight_sensitivity.jl
