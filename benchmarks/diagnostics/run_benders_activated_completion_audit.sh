#!/bin/bash
# Does the activated oracle's dual completion satisfy the full-universe dual constraints,
# and how much cut strength does it cost? See benders_activated_completion_audit.jl.
...
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-aca-%j.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-aca-%j.err
set -euo pipefail
