...
# monolithic exactness references. See benders_vs_cg_crosscheck.jl's docstring.
#SBATCH --job-name=benders_xc
...
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-xc-%j.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/benders-xc-%j.err
set -euo pipefail
...
stdbuf -oL -eL julia --startup-file=no --color=no --project="$PROJECT_ROOT" \
    benchmarks/diagnostics/benders_vs_cg_crosscheck.jl
