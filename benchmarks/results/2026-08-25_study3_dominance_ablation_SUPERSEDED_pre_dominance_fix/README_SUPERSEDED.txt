...
Study 3 note: the replacement run also changes the grid, n {15,20,25} -> {10,15,20},
and raises the pricing cap 900 -> 1800s. This study's own switch
(compensated_dominance) sits on top of the corrected base dominance rule, so both
of its arms moved -- the ablation delta here is not comparable to the new one.

Superseded by: benchmarks/experiments/2026-08-29_study3_dominance_ablation/
               benchmarks/results/2026-08-29_study3_dominance_ablation/
