...
#SBATCH --array=0-35
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/cluster-stops-%A_%a.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/cluster-stops-%A_%a.err

set -euo pipefail
ROOT=/home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl
NS=(10 15 20); SEEDS=(42 314 2718); MODES=(baseline cluster); STOPS=(10 0)
MODE_INDEX=$((SLURM_ARRAY_TASK_ID % 2))
SEED_INDEX=$(((SLURM_ARRAY_TASK_ID / 2) % 3))
N_INDEX=$(((SLURM_ARRAY_TASK_ID / 6) % 3))
STOP_INDEX=$((SLURM_ARRAY_TASK_ID / 18))
N=${NS[$N_INDEX]}; SEED=${SEEDS[$SEED_INDEX]}; MODE=${MODES[$MODE_INDEX]}; MAX_STOPS=${STOPS[$STOP_INDEX]}
STOP_LABEL=$([[ "$MAX_STOPS" -eq 0 ]] && echo uncapped || echo ms${MAX_STOPS})
