...
#SBATCH --array=0-5
#SBATCH -o /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/cg-overgen25-%A_%a.out
#SBATCH -e /home/yongzr/2025-09-JacqWang-Microtransit/StationSelection.jl/slurm_logs/cg-overgen25-%A_%a.err
...
OUT="$ROOT/results/cluster_stop_limits/overgen_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}_n25_s${SEED}_c${N_CANDIDATES}.txt"
...
julia --project=. scripts/diag_station_cluster_full_cg.jl 25 "$SEED" baseline "$OUT"
